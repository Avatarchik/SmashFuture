...
public class VRCharacterMotor : MonoBehaviour
{
    ...
    {
		GetComponent<Animation>()["Idle"].speed = Input.GetAxis("Move Y");
		GetComponent<Animation>()["Walk"].speed = Input.GetAxis("Move Y");			
        ...
        {			
			GetComponent<AudioSource>().PlayOneShot(Sound_Land, -movement.velocity.y*0.05f);
            grounded = true;
    ...
    private Vector3 ApplyGravityAndJumping(Vector3 velocity)
    {
        ...
        if(grounded)
        {
            ...
            {
				GetComponent<AudioSource>().PlayOneShot(Sound_Jump,0.8f);
				GetComponent<Animation>().Play("Jump");
                grounded = false;
